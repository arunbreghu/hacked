...
എന്നെ ഉണ്ടാക്കിയത് എന്റെ മൊതലാളി @devil_spy ആണ്ഹായ് {}, എന്റെ പേര് {}! ഞാൻ [ഇദ്ദേഹം](tg://user?id={}) നോക്കി നടത്തുന്ന ഒരു അടിപൊളി അഡ്മിൻ ബോട്ടാണ്.

എന്നെ നിർമ്മിച്ചിരിക്കുന്നത് python3 യിൽ python-telegram-bot ലൈബ്രറി ഉപയോഗിച്ചാണ്. ഞാൻ പൂർണ്ണമായിട്ടും ഓപ്പൺസോഴ്സ്ഡ് ആണ്. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://github.com/arunbreghu/hacked) കാണുവാൻ സാധിക്കും.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://t.me/devil_spy")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/devil_spy"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/devil_spy")],
